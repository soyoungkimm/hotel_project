			...
			<div class="row">
				<div class="col sona-booking" style=" border-style : solid; border-width : 1.5px; border-color : #e5e5e5; padding-bottom : 10px; opacity : 0;">
					<div class="booking-form">
						...
						<form  method="post" action="/~team2/inquiry/answer/id/<?=$row->id?>/state/<?=$row->state?>">
							<table class="table table-bordered table-sm mymargin5" style="border-top: 1px solid #e4e4e4; position: relative;">
								<tr>
									...
									<td width="80%" align="left">
										<div class="form-inline"> 
											<input  type="text" name="answer_title" size="60" maxlength="60">	
										</div>
									</td>
								</tr>									
								<tr height="250">
									...
									<td width="80%" align="left">
										<div class="form-inline"> 
											<textarea cols="110" rows="10" name="answer_content" maxlength="600"></textarea>
										</div>
									</td>
								</tr>		
							</table>
							...
							<div style="float : left; margin-left : 20px; margin-top : -20px;">
								<button class="book-button" style="width:114px" type="submit"><b>저장</b></button>
							</div>	
						</form>
					</div>
				</div>
