                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" style="text-align : right">
							...
							&nbsp;&nbsp;
							<a href="/~team2/admin_bed/edit/<?=$bed->id?>" class="btn btn-primary btn-icon-split">
								<span class="icon text-white-50">
								...
								<table class="table table-bordered">
								  <tbody>
									...
									<tr>
									  ...
									  <td width="80%">
										<input type="text" class="form-control" name="name" value="<?=$bed->name?>" readonly>
									  </td>
									</tr>
								  </tbody>
								</table>
...
<script>
	function pressDelete() {
		...
		if (answer) {
		  window.location.href = "/~team2/admin_bed/delete/<?=$bed->id?>";
		}
	}
</script>