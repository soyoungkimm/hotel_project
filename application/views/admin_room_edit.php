                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
								<form method="post" enctype="multipart/form-data" action="/~team2/admin_room/edit/<?=$data['room']->id?>" name="editForm">
									...
									<table class="table table-bordered">
									  <tbody>
										...
										<tr>
										  ...
										  <td width="80%">
											<input type="text" class="form-control" name="name" value="<?php if(set_value('name') != '') {echo set_value('name');} else {echo $data['room']->name;} ?>">	
										  </td>
										</tr>
										<tr>
										  ...
										  <td width="80%">
											<div class="filebox" style="display: inline-block;width : 100%; text-align: left;">
											  ...
											  <input class="upload-name" name="upload-name" value="<?=$data['room']->image?>" placeholder="첨부파일" readonly>
										...
										<tr>
										  ...
										  <td width="80%">
											<div class="filebox" style="display: inline-block;width : 100%; text-align: left;">
											  ...
											  <input class="upload-name2" name="upload-name2" value="<?=$data['room']->image2?>" placeholder="첨부파일" readonly>
										...
										<tr>
										  ...
										  <td width="80%">
											<input type="text" class="form-control" name="price" value="<?php if(set_value('price') != '') {echo set_value('price');} else {echo $data['room']->price;} ?>">
										  </td>
										</tr>
										<tr>
										  <th scope="row" width="20%" style="vertical-align:middle;">size <font color="red">*</font></th>
										  <td width="80%">
											<input type="text" class="form-control" name="size" value="<?php if(set_value('size') != '') {echo set_value('size');} else {echo $data['room']->size;} ?>">
										  </td>
										</tr>
										<tr>
										...
										<tr>
										  ...
										  <td width="80%">
											<input type="text" class="form-control" name="number" value="<?php if(set_value('number') != '') {echo set_value('number');} else {echo $data['room']->number;} ?>">
										  </td>
										</tr>
										<tr>
										  <th scope="row" width="20%" style="vertical-align:middle;">people_num <font color="red">*</font></th>
										  <td width="80%">
											<input type="text" class="form-control" name="people_num" value="<?php if(set_value('people_num') != '') {echo set_value('people_num');} else {echo $data['room']->people_num;} ?>">
										  </td>
										</tr>
										<tr>
										  <th scope="row" width="20%" style="vertical-align:middle;">service <font color="red">*</font></th>
										  <td width="80%">
											<textarea rows="10" class="form-control" name="service"><?php if(set_value('service') != '') {echo set_value('service');} else {echo $data['room']->service;} ?></textarea>
										  </td>
										</tr>
										<tr>
										  <th scope="row" width="20%" style="vertical-align:middle;">content <font color="red">*</font></th>
										  <td width="80%">
											<textarea rows="10" class="form-control" name="content"><?php if(set_value('content') != '') {echo set_value('content');} else {echo $data['room']->content;} ?></textarea>
										  </td>
										</tr>
									  </tbody>
									</table>
