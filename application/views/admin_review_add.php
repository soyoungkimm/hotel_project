                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
								<form method="post" enctype="multipart/form-data" action="/~team2/admin_review/add" name="addForm">
									...
									<table class="table table-bordered">
									  <tbody>
										<tr>
										  ...
										  <td width="80%">
											<select class="form-select" aria-label="Default select example" name="user_id" id="writer-select">
											<?php
											// 유효성 검사에서 안걸리면
										...
										<tr>
										  ...
										  <td width="80%">
												<input type="text" id="datepicker" class="form-control" name="writeday" value="<?php echo set_value('writeday'); ?>" />
										  </td>
										</tr>
										<tr>
										...
										<tr>
										  ...
										  <td width="80%">
											<textarea rows="10" class="form-control" name="review_content"><?php echo set_value('review_content');?></textarea>
										  </td>
										</tr>
									  </tbody>
									</table>
