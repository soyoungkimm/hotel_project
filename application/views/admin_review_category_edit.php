                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
								<form method="post" action="/~team2/admin_review_category/edit/<?=$category->id?>" name="editForm">
									...
									<table class="table table-bordered">
									  <tbody>
										...
										<tr>
										  ...
										  <td width="80%">
											<input type="text" class="form-control" name="name" value="<?php if(set_value('name') != '') {echo set_value('name');} else {echo $category->name;} ?>">
										  </td>
										</tr>
									  </tbody>
									</table>
